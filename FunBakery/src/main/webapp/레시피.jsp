                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="description">
                    ...
                    <div class="cont_ingre2">
                      ...
                      <div class="ready_ingre3" id="divConfirmedMaterialArea1">
                          <ul class="ingre_two">
                          <%ArrayList<ArrayList<BakeryVO>> taste1 = (ArrayList<ArrayList<BakeryVO>>)request.getAttribute("taste1");%>
                              ...
                              <li>
                                  <span class="ingre_name">또띠아</span>
                                  
                                  <span class="ingre_unit">2장</span>
                              </li>
                              <hr class="divider-w pt-20">
                              
                              <li><a class="ingre_name" href="javascript:viewMaterial('232');" onclick="ga('send', 'event', '레시피본문', '재료정보버튼클릭', '또띠아');">또띠아
                                  <img src="https://recipe1.ezmember.co.kr/img/mobile/icon_info.png" style="width:20px;height:20px;margin-left:2px;vertical-align: middle;"></a>
                                  <span class="ingre_unit">2장</span>
                              </li>
                              <hr class="divider-w pt-20">
                          </ul>
                          ...
                          <ul class="ingre_two">
                              ...
                              <li><a class="ingre_name" href="javascript:viewMaterial('740');" onclick="ga('send', 'event', '레시피본문', '재료정보버튼클릭', '토마토소스');">토마토소스                                                        
                                  <img src="https://recipe1.ezmember.co.kr/img/mobile/icon_info.png" style="width:20px;height:20px;margin-left:2px;vertical-align: middle;"></a>
                                  <span class="ingre_unit">4T</span>
                              </li>                                    
                          </ul>
                      </div>
                  </div>
                  ...
                  <div class="view_step">
                      ...
                      <div>
                          <div id="stepDiv" class="view_step_cont">
                              <div id="steporder" class="media-left">1
                              </div>
                              <div id="stepdescr" class="media-body">"넓은 볼에 강력분과 박력분을 담고 설탕, 소금, 이스트를 붙지 않게 떨어뜨려서 놓아줍니다.
                                  이스트에 소금이 닿으면 발효를 방해하기 때문에 따로 담아주세요."
                              </div>
                              <div id="stepimg" class="media-right">
                                  <img width="200px" src=https://recipe1.ezmember.co.kr/cache/recipe/2022/07/13/1d8afb4621728fbb4e57a4f85722e9921.jpg>
                              </div>
                              
                          </div>
                      
                          <div id="stepDiv1" class="view_step_cont">
                              <div id="steporder" class="media-left">2
                              </div>
                              <div id="stepdescr" class="media-body">설탕과 소금 이스트를 밀가루로 각각 덮어준 뒤 우유와 물을 빙 둘러서 넣어줍니다.

                              </div>
                              <div id="stepimg" class="media-right">
                                  <img width="200px" src=https://recipe1.ezmember.co.kr/cache/recipe/2022/07/13/0ff4c9c6ee272f6741f236b2ac843ba71.jpg
                                  >
                              </div>
                          </div>
                      </div>
