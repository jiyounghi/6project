              ...
              <div class="col-sm-12">
                ...
                <%
                  // 해당 레시피의 재료명과 재료량을 배열에 담아서 js로 넘기기
                     ...
                     <ul class='ingre_one' id='one_type'>
                        ...
                        const weightInput = document.querySelector(".input_ingr_weight");
                          ...
                          let table3 = document.getElementById('one_type');
                           const getInputValue = (/** @type { Event } */ event) => {
                               ...
                               table3.innerHTML = "<b class='ready_ingre3_tt'>[재료]</b>" + recipeTable.toHtml();
                           };
   
                           const init = () => {
                               form.addEventListener("submit", getInputValue, {passive: false});
                               table3.innerHTML = "<b class='ready_ingre3_tt'>[재료]</b>" + recipeTable.toHtml();
                           };
                ...
                <%
                  // 해당 레시피의 재료명과 재료량을 배열에 담아서 js로 넘기기
                     ...
                     <script>
                        ...
                        const form2 = document.querySelector(".form_ingr");
                        const nameInput2 = document.querySelector(".input_ingr_name");
                        const weightInput2 = document.querySelector(".input_ingr_weight");
