				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<h1 class="module-title font-alt">Manage</h1>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<table class="table table-striped" style="text-align: center;">
								<tr>
									...
									<th style="text-align: center;">회원 비밀번호</th>
								...
								<tr>
									...
									<td style="width: 15%;"><%=list.get(i).getUsername()%></td>
									<td style="width: 20%;"><%=list.get(i).getJoindate()%></td>
									<td style="width: 15%;">
										<!-- 회원 삭제 -->
						...
						<div class="col-sm-12" style="text-align: center;">
							<div class="pagination font-alt">
								<c:if test="${vo.prev }">
									<li><a
										href="BoardListCon?pageNum=${vo.startPage - 1 }&amount=${vo.amount}"><i
											class="fa fa-angle-left"></i></a></li>
								</c:if>


								<c:forEach var="num" begin="${vo.startPage }"
									end="${vo.endPage }">
									<li><a
										href="BoardListCon?pageNum=${num }&amount=${vo.amount}">${num }</a></li>
								</c:forEach>


								<c:if test="${vo.next }">
									<li><a
										href="BoardListCon?pageNum=${vo.endPage + 1 }&amount=${vo.amount}"><i
